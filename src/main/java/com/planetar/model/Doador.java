...
public class Doador {
	...
	public Doador(Long id, String nome, String sobrenome, String email, Number rg, Number cpf, Number telefone,
			String disponibilidade, Number numero_casa, String estado, String cidade, String bairro, String rua,
			Number cep) {
		super();
		this.id = id;
		this.nome = nome;
